...
nmds.alltypes <- plot_ordination(ps.less,ordinate(ps.less,"NMDS", "bray"),color="type", shape="type")+
  ...
  #xlab("Axis 1 (25.8%)")+
  #ylab("Axis 2 (22.5%)")+
  ggtitle("Rarefied (All)")+
  facet_wrap(~forcats::fct_relevel(site, "NR", "RI", "CL"))

#ggsave(nmds.alltypes,file="./figures/raw/nmds.alltypes.pdf",width=8,height=4)
...
#ggsave(nmds.coral.site,file="./figures/raw/nmds.coral.site.pdf",width=8,height=4)
#ggsave(nmds.coral.season,file="./figures/raw/nmds.coral.season.pdf",width=8,height=4)
#ggsave(nmds.coral.ss,file="./figures/raw/nmds.coral.ss.pdf",width=8,height=4)
#ggsave(nmds.coral.sd,file="./figures/raw/nmds.coral.sd.pdf",width=8,height=4)
...
#ggsave(nmds.coral.season.all,file="./figures/raw/nmds.coral.season.all.pdf",width=8,height=4)
#ggsave(nmds.coral.ss.all,file="./figures/raw/nmds.coral.ss.all.pdf",width=9,height=5)
```
