...
nmds.alltypes <- plot_ordination(ps.rare,ordinate(ps.rare,"NMDS", "bray"),color="type", shape="type")+
  stat_ellipse()+
  theme_cowplot()+
...
#ggsave(nmds.alltypes,file="./figures/nmds.alltypes.pdf",width=8,height=4)
...
nmds.coral.sd <- plot_ordination(ps.coral, ordinate(ps.coral,"NMDS", "bray"), color="density")+
 # stat_ellipse()+
  theme_cowplot()+
  geom_point(size=3)+
...
#ggsave(nmds.coral.site,file="./figures/nmds.coral.site.pdf",width=8,height=4)
#ggsave(nmds.coral.season,file="./figures/nmds.coral.season.pdf",width=8,height=4)
#ggsave(nmds.coral.ss,file="./figures/nmds.coral.ss.pdf",width=8,height=4)
#ggsave(nmds.coral.sd,file="./figures/nmds.coral.sd.pdf",width=8,height=4)
...
#ggsave(nmds.coral.season.all,file="./figures/nmds.coral.season.all.pdf",width=8,height=4)
#ggsave(nmds.coral.ss.all,file="./figures/nmds.coral.ss.all.pdf",width=9,height=5)
```
