...
mdf.prep <- prep_mdf(ps.coral.allid, subgroup_level = "Family")
...
mdf.coral <- color.obj$mdf 
cdf.coral <- color.obj$cdf 
...
new.sample.order.coral <- reorder_samples_by(mdf.coral, cdf.coral, order = "Proteobacteria", group_level = "Phylum", subgroup_level = "Family", sink_abundant_groups = FALSE)
