...
summary(a.div.symb.seas)
  #                 Df Sum Sq Mean Sq F value Pr(>F)  
  #symbstate         1  0.027  0.0274   0.046 0.8317  
  #season            1  2.449  2.4494   4.101 0.0501 .
  #symbstate:season  1  0.642  0.6424   1.076 0.3064  
  #Residuals        37 22.098  0.5973  
# ANOVA tells you whether results significant overall; TukeyHSD tells you which groups significantly different
TukeyHSD(a.div) # NR-CL sig (.)
TukeyHSD(a.div.symb) # all ns
TukeyHSD(a.div.symb.seas) #season sig (.)
