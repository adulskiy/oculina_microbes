...
#ggsave(gg.sha.coral.sd,file="~/oculina/diversity/figures/rare-figs/gg.sha.coral.sd.rare.png",width=8,height=4)
#ggsave(gg.sha.coral.sd.sqrt,file="~/oculina/diversity/figures/rare-figs/gg.sha.coral.sd.sqrt.rare.png",width=8,height=4)
...
#reorder sites
sample_data(ps.rar)$site <- factor(sample_data(ps.less)$site, levels=c("NR","RI","CL"))
