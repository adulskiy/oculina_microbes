...
#all types
gg.sha.site.alltypes <-ggplot(df.div,aes(x=type,y=Shannon,color=type))+
...
gg.sha.seas.alltypes <-ggplot(df.div,aes(x=type,y=Shannon,color=type))+
  geom_boxplot(outlier.shape=NA)+
  scale_color_manual(values=c("darksalmon","paleturquoise3","chocolate4"))+
  scale_x_discrete(labels=c("Coral","SW","Sed."))+
  geom_jitter(alpha=0.5)+
...
#ggsave(gg.sha.site.alltypes,file="./figures/gg.sha.site.alltypes.pdf",width=8,height=4)
#ggsave(gg.sha.seas.alltypes,file="./figures/gg.sha.seas.alltypes.pdf",width=8,height=4)
...
#ggsave(gg.sha.coral.site,file="./figures/gg.sha.coral.site.pdf",width=8,height=4)
...
plot.less <- plot_microshades(mdf.less, cdf.less, group_label = "Phylum Genus")
