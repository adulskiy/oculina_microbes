...
# glm.1c best
summary(glm.1c) #so none of the variables are predictive of evenness?
#               Estimate Std. Error t value Pr(>|t|)    
#(Intercept)   7.966e-01  2.900e-02  27.467   <2e-16 ***
#density_sqrt -8.770e-06  1.136e-05  -0.772    0.444  

tab_model(glm.1c, digits=5)
...
df.div.coral.pd$season <- relevel(df.div.coral$season, ref="Summer")
df.div.coral.pd$site <- as.factor(df.div.coral$site)
df.div.coral.pd$site <- relevel(df.div.coral$site, ref="NR")
df.div.coral.pd$density_sqrt <- sqrt(df.div.coral$density)
df.div.coral.pd$density_sqrt <- as.numeric(df.div.coral$density_sqrt)
str(df.div.coral.pd)
